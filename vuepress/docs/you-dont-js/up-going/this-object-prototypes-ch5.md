...
在 JavaScript 中有一种奇异的行为被无耻地滥用了许多年来 _山寨_ 成某些 _看起来_ 像“类”的东西。我们来仔细看看这种方式。
...
<img src="./this-object-prototypes-fig3.png">
...
先入为主，“继承”这个词有很强烈的含义（见第四章）。仅仅在它前面加入“原型”来区别于 JavaScript 中 _实际上几乎相反_ 的行为，使真相在泥泞般的困惑中沉睡了近二十年。
