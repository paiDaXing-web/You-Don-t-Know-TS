...
**注意：** 更多关于 JavaScript 的`object`的信息，请参见本系列的 _this 与对象原型_，特别是第三章。
...
**注意：** 关于 strict 模式的更多信息，参见本系列的 _类型与文法_ 的第五章。
...
JavaScript 中的原型机制十分复杂。我们在这里仅仅扫它一眼。要了解关于它的所有细节，你需要花相当的时间来学习本系列的 _this 与对象原型_ 的第四到六章。
