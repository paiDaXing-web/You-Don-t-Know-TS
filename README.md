...
- [第五章:泛型 Generics](docs/Generics.md)
  ...
  - [5.4 泛型约束](docs/Generics.md#54-泛型约束)
    - [5.4.1 泛型约束](docs/Generics.md#541-确保属性存在)
    - [5.4.2 泛型约束](docs/Generics.md#542-检查对象上的键是否存在)
  - [5.5 泛型参数默认类型](docs/Generics.md#55-泛型参数默认类型)
  - [5.6 泛型条件类型](docs/Generics.md#56-泛型条件类型)
  - [5.7 泛型工具类型](docs/Generics.md#57-泛型工具类型)
    - [5.7.1 泛型约束](docs/Generics.md#571-partial)
    - [5.7.2 泛型约束](docs/Generics.md#572-record)
    - [5.7.3 泛型约束](docs/Generics.md#573-pick)
    - [5.7.4 泛型约束](docs/Generics.md#574-exclude)
    - [5.7.5 泛型约束](docs/Generics.md#575-returntype)
  - [5.8 使用泛型创建对象](docs/Generics.md#58-使用泛型创建对象)
    - [5.8.1 泛型约束](docs/Generics.md#581-构造签名)
    - [5.8.2 泛型约束](docs/Generics.md#582-构造函数类型)
    - [5.8.3 泛型约束](docs/Generics.md#583-构造函数类型的应用)
    - [5.8.4 泛型约束](docs/Generics.md#584-使用泛型创建对象)
